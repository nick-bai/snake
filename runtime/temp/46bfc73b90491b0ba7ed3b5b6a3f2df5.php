<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:54:"/work/cpic/public/../application/admin/view/index.html";i:1524184440;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <?php if(authCheck('profile/headedit')): ?>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('admin/profile/headedit'); ?>">修改信息</a>
                            </li>
                            <?php endif; ?>
                            <li>
                                <a class="J_menuItem" href="<?php echo url('admin/profile/index'); ?>">修改密码</a>
                            </li>
                            <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2017-2019 <a href="http://baiyf.com" target="_blank">baiyf.com</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
